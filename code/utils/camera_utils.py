...
def loadCam(args: GroupParams, id: int, cam_info: CameraInfo, resolution_scale: float) -> Camera:
    ...
    resized_image_rgb_norImg= PILtoTorch(cam_info.image_norImg, resolution)  # 

    gt_image = resized_image_rgb[:3, ...]
    gt_image_norImg = resized_image_rgb_norImg[:3, ...]
    ...
    return Camera(
        ...
        event=cam_info.event, hdr=cam_info.hdr, image_norImg=gt_image_norImg, expourse_time=cam_info.expourse_time
    )
