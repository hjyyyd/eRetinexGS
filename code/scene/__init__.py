...
class Scene:
    ...
    def __init__(
        ...
        self.train_cameras = {}
        self.test_cameras = {}
        aaa=os.path.join(args.source_path, "sparse")
        print(f"==>> aaa: {aaa}")

        if os.path.exists(os.path.join(args.source_path, "sparse")):
            if os.path.exists(os.path.join(args.source_path, "event_npy")):
                scene_info = sceneLoadTypeCallbacks["Colmap_ev"](args.source_path, args.images, args.eval)   # args.images: "images"
            else:
                scene_info = sceneLoadTypeCallbacks["Colmap"](args.source_path, args.images, args.eval)
        elif os.path.exists(os.path.join(args.source_path, "transforms_event.json")):
            scene_info = sceneLoadTypeCallbacks["Blender_ev"](args.source_path, args.white_background, args.eval)

        # elif os.path.exists(os.path.join(args.source_path, "transforms_train.json")):
        #     if "stanford-orb" in args.source_path:
